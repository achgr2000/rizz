...
/**
 * Generate reply suggestions using OpenRouter API with Qwen3 235B A22B model
 */
    ...
    `;
        ...
        const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
            ...
            headers: {
                ...
                'HTTP-Referer': 'http://localhost:8000', // Replace with your website URL in production
                'X-Title': 'Reply Suggestions Widget'
            },
            body: JSON.stringify({
        ...
        if (!response.ok) {
            ...
            throw new Error(errorData.error?.message || 'Failed to generate replies');
        }
